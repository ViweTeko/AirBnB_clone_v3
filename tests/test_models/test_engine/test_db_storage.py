...
class TestDBStorage(unittest.TestCase):
    """Try out the DBStorage class""""

    @unittest.skipIf(os.getenv(HBNB_TYPE_STORAGE) != 'db',
                     "not testing db storage")
    def test_get(self):
        """Check that the 'get' function returns a particular object or nothing"""
    ...
    @unittest.skipIf(os.getenv(HBNB_TYPE_STORAGE) != 'db',
                     "not testing db storage")
    def test_count(self):
        """Verify that the 'new' function adds an object to the database"""
